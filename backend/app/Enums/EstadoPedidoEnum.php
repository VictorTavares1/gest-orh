...
enum EstadoPedidoEnum: string
{
    ...
    public function transicoesPermitidas(): array
    {
        return match($this) {
            ...
            self::PENDENTE               => [self::EM_APROVACAO_COLEGA, self::EM_APROVACAO_DIRETOR, self::CANCELADO, self::REJEITADO],
            self::EM_APROVACAO_COLEGA    => [self::EM_APROVACAO_DIRETOR, self::REJEITADO, self::CANCELADO],
            self::EM_APROVACAO_DIRETOR   => [self::EM_APROVACAO_EXECUTIVA, self::APROVADO, self::REJEITADO, self::CANCELADO],
            self::EM_APROVACAO_EXECUTIVA => [self::APROVADO, self::REJEITADO, self::CANCELADO],
            default                      => [],
        };
    }
