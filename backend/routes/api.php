...
Route::prefix('v1')->name('v1.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('role:diretora_executiva')->group(function () {
            ...
            Route::patch('/organizacoes/{organizacao}', [\App\Http\Controllers\API\V1\OrganizacaoController::class, 'update'])->name('organizacoes.patch');

            Route::apiResource('/setores', \App\Http\Controllers\API\V1\SetorController::class)
                ->parameters(['setores' => 'setor'])
                ->except(['index']);
            Route::patch('/setores/{setor}', [\App\Http\Controllers\API\V1\SetorController::class, 'update'])->name('setores.patch');
            ...
            Route::patch('/periodos/{periodo}', [\App\Http\Controllers\API\V1\PeriodoController::class, 'update'])->name('periodos.patch');
        });
